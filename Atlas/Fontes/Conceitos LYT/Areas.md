...
> [!mountain] **[[Atlas/Fontes/Conceitos LYT/Areas]]** | [[projetos]] | [[Trabalhos]]  

Quando uma **área de esforço** cresce o suficiente, ela justifica uma nota dedicada para acompanhar todos os projetos dessa área. A visualização abaixo mostra qualquer nota de área, ordenada por classificação (rank).
