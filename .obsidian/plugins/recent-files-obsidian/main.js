...
var D = (C, t) => () => (t || C((t = { exports: {} }).exports, t), t.exports),
    ...
    Z = (C, t, e, a) => {
        if ((t && typeof t == "object") || typeof t == "function")
            for (let n of G(t))
                !K.call(C, n) && n !== e && y(C, n, { get: () => t[n], enumerable: !(a = $(t, n)) || a.enumerable });
        return C;
    };
var Y = (C, t, e) => (
        (e = C != null ? W(J(C)) : {}),
        Z(t || !C || !C.__esModule ? y(e, "default", { value: C, enumerable: !0 }) : e, C)
    ),
...
var V = D((p) => {
    ...
    var e1 =
        ...
        T =
            (p && p.__exportStar) ||
            function (C, t) {
                for (var e in C) e !== "default" && !Object.prototype.hasOwnProperty.call(t, e) && e1(t, C, e);
            };
    Object.defineProperty(p, "__esModule", { value: !0 });
    p.getApiSafe = p.getDefer = p.isPluginEnabled = p.PluginNotEnabledError = p.pluginId = void 0;
    T(I(), p);
    T(S(), p);
    T(H(), p);
    ...
    function t1(C) {
        var t, e, a;
        return (a =
            (e = (t = C == null ? void 0 : C.plugins) === null || t === void 0 ? void 0 : t.enabledPlugins) === null ||
            e === void 0
                ? void 0
    ...
    function z(C) {
        ...
        let s =
                (e =
                    ...
                    : null,
            h =
                (n = (a = s == null ? void 0 : s.getDefer) === null || a === void 0 ? void 0 : a.call(s)) !== null &&
                n !== void 0
                    ? n
                    : null;
        if (h === null) throw new w(`Plugin ${p.pluginId} is not enabled or old version`);
        return h;
    }
    p.getDefer = z;
    function a1(C) {
    ...
    var k = class {
        ...
        getResolverFactory() {
            ...
            return (
                this.before(),
                (e = (t = this.api) === null || t === void 0 ? void 0 : t.getResolverFactory()) !== null && e !== void 0
                    ? e
                    : null
            );
        }
        getEventDispatcher() {
            ...
            return (
                this.before(),
                (e = (t = this.api) === null || t === void 0 ? void 0 : t.getEventDispatcher()) !== null && e !== void 0
                    ? e
                    : null
            );
        }
        getEnabledFeatures() {
            ...
            return (
                this.before(),
                (e = (t = this.api) === null || t === void 0 ? void 0 : t.getEnabledFeatures()) !== null && e !== void 0
                    ? e
                    : []
            );
        }
...
var l = require("obsidian"),
    N = Y(V()),
    q = 50,
    i1 = { recentFiles: [], omittedPaths: [], omittedTags: [], updateOn: "file-open", omitBookmarks: !1 },
    u = "recent-files",
    b = class extends l.ItemView {
        constructor(e, a, n) {
            ...
            this.redraw = () => {
                ...
                this.data.recentFiles.forEach((i) => {
                    ...
                    let d = n.createDiv({ cls: "tree-item nav-file recent-files-file" }),
                        r = d.createDiv({ cls: "tree-item-self is-clickable nav-file-title recent-files-title" }),
                    ...
                    E && E !== "md" && m.setText(E),
                        ...
                        r.addEventListener("contextmenu", (c) => {
                            ...
                            let L = this.app.vault.getAbstractFileByPath(i == null ? void 0 : i.path);
                            this.app.workspace.trigger("file-menu", v, L, "link-context-menu"),
                        ...
                        g.addEventListener("mousedown", (c) => {
                            i && c.button === 1 && (c.preventDefault(), this.focusFile(i, "tab"));
                        });
                    let O = r.createDiv({ cls: "recent-files-file-delete menu-item-icon" });
            ...
            this.removeFile = async (e) => {
                (this.data.recentFiles = this.data.recentFiles.filter((a) => a.path !== e.path)),
            ...
            this.focusFile = (e, a) => {
                ...
                n
                    ...
                    : (new l.Notice("Cannot find a file with that name"),
                      (this.data.recentFiles = this.data.recentFiles.filter((s) => s.path !== e.path)),
        ...
        onPaneMenu(e) {
            e.addItem((a) => {
                a.setTitle("Clear list")
                    .setIcon("sweep")
                    .onClick(async () => {
                        (this.data.recentFiles = []), await this.plugin.saveData(), this.redraw();
                    });
            }).addItem((a) => {
                a.setTitle("Close")
                    .setIcon("cross")
    ...
    M = class extends l.Plugin {
        constructor() {
            ...
            this.pruneLength = async () => {
                ...
                e > 0 && this.data.recentFiles.splice(this.data.recentFiles.length - e, e), await this.saveData();
            };
            this.shouldAddFile = (e) => {
                ...
                let a = this.data.omittedPaths.filter((i) => i.length > 0),
                    n = (i) => {
                        try {
                            ...
                            return console.error("Recent Files: Invalid regex pattern: " + i), !1;
                        }
                    };
                ...
                if (s) {
                    let i = this.data.omittedTags.filter((g) => g.length > 0),
                        d =
                            (o = (f = this.app.metadataCache.getFileCache(s)) == null ? void 0 : f.frontmatter) == null
                                ? void 0
                                : o.tags,
                        r = (g) => {
                            try {
                                ...
                                return console.error("Recent Files: Invalid regex pattern: " + g), !1;
                            }
                        };
                    if (i.some(r)) return !1;
                }
                let h = this.app.internalPlugins.getEnabledPluginById("bookmarks");
                return !(s && this.data.omitBookmarks && h && h.items.some(({ path: d }) => d === s.path));
            };
            this.update = async (e) => {
                if (!e) return;
            ...
            this.waitingForEdit = async (e, a) => {
                this.update(e), this.app.workspace.off("quick-preview", this.waitingForEdit);
            };
            this.updateData = async (e) => {
                ...
                this.shouldAddFile(e) &&
                    (this.data.recentFiles.unshift({ basename: e.basename, path: e.path }), (n = !0)),
        ...
        async onload() {
            console.log("Recent Files: Loading plugin v" + this.manifest.version),
                ...
                this.app.workspace.registerHoverLinkSource(u, { display: "Recent Files", defaultMod: !0 }),
    ...
    x = class extends l.PluginSettingTab {
        ...
        display() {
            ...
            (a.href =
                ...
                (a.text = "MDN - Regular expressions"),
...
`)),
            ...
            n.append("Frontmatter-tag patterns to ignore. One pattern per line."),
                new l.Setting(t)
...
`)),
                ...
                new l.Setting(t).setName("Update list when file is:").addDropdown((o) => {
                    o.addOption("file-open", "Opened")
                ...
                new l.Setting(t)
                    ...
                    .addText((o) => {
                        ...
                        o.inputEl.setAttr("type", "number"),
                            ...
                            o
                                .setValue(((i = this.plugin.data.maxLength) == null ? void 0 : i.toString()) || "")
                                .onChange((d) => {
                                    let r = parseInt(d, 10);
            ...
            h.appendText(
                ...
                s.appendChild(h);
            let f = new DOMParser();
            s.appendChild(j("https://paypal.me/tgrosinger", f.parseFromString(s1, "text/xml").documentElement)),
                s.appendChild(
                    j("https://www.buymeacoffee.com/tgrosinger", f.parseFromString(n1, "text/xml").documentElement)
                );
        }
    },
    j = (C, t) => {
        let e = document.createElement("a");
        return e.setAttribute("href", C), e.addClass("recent-files-donate-button"), e.appendChild(t), e;
    },
    C1 = `
