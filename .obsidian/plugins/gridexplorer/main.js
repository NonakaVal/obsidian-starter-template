...
var NameInputModal = class extends import_obsidian4.Modal {
  ...
  onOpen() {
    ...
    const { contentEl } = this;
    contentEl.empty();
    new import_obsidian4.Setting(contentEl).setName(this.titleText).setDesc((_a = this.descText) != null ? _a : "").addText((text) => {
...
async function createShortcut(app, folderPath, option) {
  try {
    ...
    new import_obsidian10.Notice(`${t("shortcut_created")}: ${shortcutName}`);
  } catch (error) {
    console.error("Create shortcut error", error);
    new import_obsidian10.Notice(t("failed_to_create_shortcut"));
  }
}
